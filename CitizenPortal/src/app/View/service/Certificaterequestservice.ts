...
export class CertificateRequestService {
  ...
  update(certificaterequest: Certificaterequest): Promise<[] | undefined> {
    return this.http.put<[]>(this.url + '/' + certificaterequest.id, certificaterequest).toPromise();
  }
  ...
  // Called after citizen downloads PDF — changes status to Completed (5)
  complete(id: number): Promise<[] | undefined> {
    return this.http.put<[]>(`${this.url}/${id}/complete`, {}).toPromise();
  }
