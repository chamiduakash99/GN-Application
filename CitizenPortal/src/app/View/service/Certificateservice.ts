...
export class CertificateService {
  ...
  update(certificate: Certificate): Promise<[] | undefined> {
    return this.http.put<[]>(this.url + '/' + certificate.id, certificate).toPromise();
  }
  ...
  // Returns raw PDF bytes for citizen download
