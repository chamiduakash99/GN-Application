...
export class CountByStreetMaterialComponent implements OnInit {
  ...
  ngOnInit(): void {
    let asphalt = new CountByStreetMaterial(1, "Asphalt", 20, 0);
    let concrete = new CountByStreetMaterial(2, "Concrete", 12, 0);
    let gravel = new CountByStreetMaterial(3, "Gravel", 8, 0);
    let tar = new CountByStreetMaterial(4, "Tar", 5, 0);
    let unpaved = new CountByStreetMaterial(5, "Unpaved", 3, 0);
