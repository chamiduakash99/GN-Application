...
public class CertificateController {
    ...
    // ──────────────────────────────────────────────────────────────
    // GET /certificates[?certificateno=X&requestId=Y]
    // ──────────────────────────────────────────────────────────────
    ...
    public List<Certificate> get(@RequestParam HashMap<String, String> params) {
        ...
        // NOTE: param key renamed from "cetificateno" to "certificateno" —
        // this is what the Angular client's btnSearchCert() actually sends.
        String certificateno = params.get("certificateno");
        if (certificateno != null)
            stream = stream.filter(c -> c.getCertificateno() != null &&
                    c.getCertificateno().contains(certificateno));
    ...
    public HashMap<String, String> add(@RequestBody Certificate certificate) {
        ...
        } else if (certificatedao.findByCertificateno(certificate.getCertificateno()) != null) {
