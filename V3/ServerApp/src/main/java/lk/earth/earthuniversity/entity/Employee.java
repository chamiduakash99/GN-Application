...
public class Employee {
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "employee")
    private Collection<Certificate> certificatesById;
    @JsonIgnore
    @OneToMany(mappedBy = "employee")
    private Collection<Announcement> announcementsById;
    @JsonIgnore
    @OneToMany(mappedBy = "employee")
    ...
    public Collection<Certificate> getCertificatesById() {
        return certificatesById;
    }

    public void setCertificatesById(Collection<Certificate> certificatesById) {
        this.certificatesById = certificatesById;
    }

    public Collection<Announcement> getAnnouncementsById() {
        return announcementsById;
    }

    public void setAnnouncementsById(Collection<Announcement> announcementsById) {
        this.announcementsById = announcementsById;
    }
