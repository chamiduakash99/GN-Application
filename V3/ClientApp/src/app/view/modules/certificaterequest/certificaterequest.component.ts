...
import {CertificaterequestService} from '../../../service/certificaterequestservice'; // FIX: lowercase r
...
export class CertificaterequestComponent implements OnInit {
  ...
  statusSummary: any[] = []; // capital S — matches HTML
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // APPROVE
  // FIX: status check moved BEFORE opening the confirm dialog
  // ════════════════════════════════════════════════════════════════════════════
  approve() {
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // CREATE CERTIFICATE
  // FIX: assigns certificaterequest FK + captures returned ID
  // ════════════════════════════════════════════════════════════════════════════
  createCertificate() {
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // UPLOAD SCAN
  // Converts base64 preview to byte array and PUTs to server.
  // Server sets request status → Certificate Ready (4).
  // ════════════════════════════════════════════════════════════════════════════
  uploadScan() {
...
//   // oldcertificaterequest: Certificaterequest = new Certificaterequest();
//
